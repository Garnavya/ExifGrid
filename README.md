...
- This project does not yet have a LICENSE file — one is coming; treat the repo as all-rights-reserved until it's added.
...
MIT (license file to be added — see [Known Limitations](#known-limitations)).
